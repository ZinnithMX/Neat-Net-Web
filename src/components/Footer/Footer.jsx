    ...
    return (
        <footer
            ...
            <div className="flex flex-col md:flex-row items-center justify-between w-full">
                <a href="/TOS" className="text-sm text-g-50 mb-2 md:mb-0 md:mr-4">Términos y Condiciones</a>
                <a href="/Privacy" className="text-sm text-g-50 mb-2 md:mb-0 md:mr-4">Política de Privacidad</a>
